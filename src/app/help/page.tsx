...
const sections: Section[] = [
  ...
  },
  {
    ...
    content: [
      ...
      '日付・時刻は試合の日時を入力しておくと管理しやすくなります。デフォルトは現在日時が入力されています。',
  ...
  },
  {
    title: 'タイマー',
    content: [
      'スタメン画面のコート下部に時計アイコンがあります。タップするとタイマーが表示されます。',
      '5分・10分・15分・20分から試合時間を選択できます。',
      '「スタート」で計測開始、「一時停止」で一時停止、「リセット」でゼロに戻ります。',
      '「経過時間」「残り時間」の表示を切り替えられます。',
      '残り5分で橙色、残り1分で赤色に変わります。',
    ],
  },
  {
    title: 'データの保存',
  ...
  },
  {
    ...
    content: [
      ...
      'バイオレット・ブルー・グリーン・ローズ・アンバー・イエロー・ライム・ピンクの8色から選択できます。',
